...
r.scene = [
    ...
    Cube(V3(-1.5, -0.75, -9.25), 0.5, orange9),
    Cube(V3(-1, -0.75, -9.25), 0.5, orange10),
    Cube(V3(-1.5, -0.25, -9.25), 0.5, orange6),
    Cube(V3(-1, -0.25, -9.25), 0.5, orange6),
    Cube(V3(-0.5, -0.25, -9.25), 0.5, orange6),
    Cube(V3(-0.5, -0.75, -9.25), 0.5, orange10),
    Cube(V3(-0.5, -1.25, -9.25), 0.5, orange9),
    ...
    Cube(V3(1, -1.25, -9.25), 0.5, orange8),
    Cube(V3(0.5, -1.25, -9.25), 0.5, orange8),
    Cube(V3(0, -1.25, -9.25), 0.5, orange9),
    Cube(V3(0, -0.75, -9.25), 0.5, orange10),
    Cube(V3(0, -0.25, -9.25), 0.5, orange6),
    Cube(V3(0.5, -0.25, -9.25), 0.5, orange6),
    Cube(V3(1, -0.25, -9.25), 0.5, orange6),
    Cube(V3(0.5, -0.75, -9.25), 0.5, orange10),
    Cube(V3(1, -0.75, -9.25), 0.5, orange9),
